...
SELECT
       ...
       , MAIN.trx_num
       , MAIN.patient_name
	   ---,(MAIN.trx_date)trx_date
	   , TRUNC(TO_DATE(TO_CHAR(MAIN.trx_date, 'DD-MON-YYYY'),'DD-MON-YYYY'))trx_date
      ---- ,TO_DATE (MAIN.trx_date) trx_date
       , MAIN.trx_cur
       , MAIN.trx_amt
       , MAIN.trx_unpaid
       , MAIN.trx_deduction
                              ...
                              FROM
                                     (
                                            ...
                                            SELECT
                                                 ...
                                                 , TRUNC(TO_DATE(TO_CHAR(aia.invoice_date, 'YYYY-MM-DD'),'YYYY-MM-DD'))          trx_date
